...
<h1 className="mt-[2.5rem] text-[40px] text-[#9EDE52]">Web Portfolio</h1>   
...
<p><span className="text-[#9EDE52]">Web Portfolio</span>는 제 소개를 하기 위해 만든 웹 사이트입니다. </p>
<p>Wep Portfolio에 들어오게 되면 여러 animation으로 만든 </p>
<p>Landing Page가 먼저 보이게 되고, 그 다음으로는</p>
<p>제 소개와 더불어 저의 방향성과 목표를 담은 component를 넣었습니다.</p>
<p>그리고 제가 현재 할 수 있는 기술들과 제가 한 프로젝트들을 넣었습니다.</p>
<p></p>
...
<div className="p-8 text-[1.4rem] max-[1173px]:text-[1.3rem] max-[973px]:text-[1.1rem] leading-[3rem]">
<p>기간 : <span className="ml-[4.6rem]">2025.2.1 ~ 2025.2.25</span> </p>
<p>주요 기능 : <span className="ml-8">Router, animation, Responsive Design</span></p>
<p>주요 기술 : <span className="ml-8">React, TailwindCSS</span></p>
...
<div className="mt-[2rem] w-full h-auto bg-black  shadow-xl shadow-[#6a942e]">
<div className="p-8 text-[1.4rem] max-[1173px]:text-[1.3rem] max-[973px]:text-[1.1rem] leading-[3rem]">
<p>프로젝트의 상세내용을 눌렀을 때, 스크롤이 내려온 상태로</p>
<p>들어가지는 문제가 있었습니다. 이 문제를 해결하기 위해 useEffect로</p>
<p>window.scrollTo(0,0)로 들어오자마자 위로 와지게끔 하여 해결했습니다.</p>
</div>
</div>
<br></br> <br></br>
