...
export default function FoodFinder(){
  ...
  >
    ...
    <div className="border-2 rounded-[20px] border-[#9EDE52] p-2 cursor-pointer"><span className="text-[#9EDE52]">GitHub</span></div>
    </div>
    ...
    <p>메인 페이지는 kakao API기반으로 만들어졌고 kakao지도에 부산 맛집들이 마커 표시로 뜨며</p>
    <p>왼쪽 사이드바에는 부산 맛집들 정보와 검색,예약 기능이 있습니다.</p>
    <p>검색 시, kakao지도에서 검색한 가게의 좌표로 이동됩니다. </p>
    <p>예약 버튼을 누르게 되면 날짜,시간이 뜨게되고 원하는 날짜로 예약할 수 있고</p>
    <p>만약 같은 날짜로 예약 시, 예약이 안되고 알림문구가 뜨게됩니다.</p>
    <p>"오늘 뭐 먹을까?" 라는 버튼을 누를 시, 모달 창과 함께 부산 맛집중 랜덤으로 이름이 뜨게됩니다. </p>
    </div>
    </div>
    ...
    <div className="p-8 text-[1.4rem] max-[1173px]:text-[1.3rem] max-[973px]:text-[1.1rem] leading-[3rem]">
    <p>기간 : <span className="ml-[4.6rem]">2024.12.26 ~ 2025.1.12</span> </p>
    <p>주요 기능 : <span className="ml-8">로그인, 회원가입, 검색, 즐겨찾기, 음식 랜덤 추천</span></p>
    <p>주요 기술 : <span className="ml-8">React, Styled-components, Json</span></p>
    <p>깃허브 : <span className="ml-[3.3rem]"><a href="https://github.com/sungsieon/FoodFinder"><span className="text-[1rem] border-1 p-[5px] rounded-[6px] bg-green-700 cursor-pointer">깃허브 URL</span></a></span></p>
    <p>URL : <span className="ml-[4.4rem]"><a href="https://sungsieon.github.io/FoodFinder/"><span className="text-[1rem] border-1 p-[5px] rounded-[6px] bg-green-700 cursor-pointer">배포 URL</span></a></span></p>
    </div>
    </div>
    ...
    <p>  이렇게 하니 각 가게의 예약 정보를 쉽게 불러오고 수정할 수 있었다.</p>
    </div>
    </div>
    <br></br> <br></br>
